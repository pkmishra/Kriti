...
# You might add methods and properties to the mediator here
  ...
  #mediator.isCurrentUserAuthenticated =  mediator.user && !mediator.user.disposed
  #Following is a function not property because it should be evaluated each time
mediator.isCurrentUserAuthenticated = ->
       mediator.user && !mediator.user.disposed
